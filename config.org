...
(setq doom-font (font-spec :family "Bitstream Vera Sans" :size 16)
      doom-big-font (font-spec :family "Bitstream Vera Sans" :size 22)
      doom-variable-pitch-font (font-spec :family "Bitstream Vera Sans Mono" :size 16))
